...
function mhallu.get_suit(card, ver) --Explains itself quite well
  if ver == "L" then
...
function mhallu.get_upgrade(card, upgrade) --Pretty sure I never used this lmao
...
function mhallu.change_base(card, suit, rank) --Custom change_base because SMODS was being silly
